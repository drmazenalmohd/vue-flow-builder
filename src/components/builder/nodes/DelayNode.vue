// src/components/builder/nodes/DelayNode.vue
...
<template>
  <div class="delay-node" :class="{ selected }">
    ...
    <div class="node-text">{{ data.delay ? `${data.delay} seconds` : 'Click edit to set delay' }}</div>
